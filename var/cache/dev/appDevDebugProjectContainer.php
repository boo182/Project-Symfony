...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'ac_platform.antispam' => 'getAcPlatform_AntispamService',
            ...
            'security.user.provider.concrete.my_provider' => 'getSecurity_User_Provider_Concrete_MyProviderService',
    ...
    /**
     * Gets the 'ac_platform.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \CA\BlogBundle\Antispam\CAAntispam A CA\BlogBundle\Antispam\CAAntispam instance
     */
    protected function getAcPlatform_AntispamService()
    {
        return $this->services['ac_platform.antispam'] = new \CA\BlogBundle\Antispam\CAAntispam();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('FuIArp3eZf', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o3QeUyd7c6', 0, 'ZF9pOvL2dZiCJSnuE+D7AG', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 3306, 'dbname' => 'coding_ter', 'user' => 'martin', 'password' => 1234, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/CA/BlogBundle/Entity'))), 'CA\\BlogBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('CABlogBundle' => 'CA\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6921a320710d16bed6273ff931cdc541ff3b45d97d5010924566505bda02cbde');
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('CA\\BlogBundle\\Entity\\User' => array('algorithm' => 'sha512', 'hash_algorithm' => 'sha512', 'key_length' => 40, 'ignore_case' => false, 'encode_as_base64' => true, 'iterations' => 5000, 'cost' => 13)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = ${($_ = isset($this->services['security.user.provider.concrete.my_provider']) ? $this->services['security.user.provider.concrete.my_provider'] : $this->getSecurity_User_Provider_Concrete_MyProviderService()) && false ?: '_'};
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/new');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/\\d+/edit$', NULL, array(0 => 'PUT'));

        $k = new \Symfony\Component\Security\Http\AccessMap();
        $k->add($i, array(0 => 'ROLE_BLOGGER'), NULL);
        $k->add($j, array(0 => 'ROLE_ADMIN'), NULL);

        $l = new \Symfony\Component\Security\Http\HttpUtils($f, $f);

        $m = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'b33280bc25795c192d1208612baf2781a57091df', 'main', array('lifetime' => 604800, 'path' => '/', 'name' => 'REMEMBERME', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        ...
        $r = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $h, $o, $l, 'main', $p, $q, array('check_path' => 'login', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $r->setRememberMeServices($m);

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d, $e), 2 => $n, 3 => $r, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $m, $h, $a, $d, true, $o), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '58f4a4a10f5182.20938059', $a, $h), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, ${($_ = isset($this->services['debug.security.access.decision_manager']) ? $this->services['debug.security.access.decision_manager'] : $this->getDebug_Security_Access_DecisionManagerService()) && false ?: '_'}, $k, $h)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $e, $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($g, $l, 'login', false), NULL, NULL, $a, false), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.my_provider', 'main', 'security.authentication.form_entry_point.main', NULL, NULL, array(0 => 'logout', 1 => 'form_login', 2 => 'remember_me', 3 => 'anonymous')));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('webmaster', 'lulu');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/CA/BlogBundle/Resources/views'), 'CABlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b33280bc25795c192d1208612baf2781a57091df');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('J5IYYPKwjB', 0, 'ZF9pOvL2dZiCJSnuE+D7AG', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider(${($_ = isset($this->services['security.user.provider.concrete.my_provider']) ? $this->services['security.user.provider.concrete.my_provider'] : $this->getSecurity_User_Provider_Concrete_MyProviderService()) && false ?: '_'}, $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, 'b33280bc25795c192d1208612baf2781a57091df', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('58f4a4a10f5182.20938059')), true);
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_BLOGGER' => array(), 'ROLE_ADMIN' => array(0 => 'ROLE_BLOGGER')));
    }

    /**
     * Gets the 'security.user.provider.concrete.my_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['security.user.provider.concrete.my_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'CABlogBundle:User', 'username', NULL);
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'CABlogBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/CA/BlogBundle'),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'CABlogBundle' => 'CA\\BlogBundle\\CABlogBundle',
            ...
            'secret' => 'b33280bc25795c192d1208612baf2781a57091df',
            'app_webmaster' => 'lulu',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'b33280bc25795c192d1208612baf2781a57091df',
