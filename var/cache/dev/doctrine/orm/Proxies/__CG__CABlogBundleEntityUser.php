...
namespace Proxies\__CG__\CA\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \CA\BlogBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'CA\\BlogBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'CA\\BlogBundle\\Entity\\User' . "\0" . 'posts', '' . "\0" . 'CA\\BlogBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'CA\\BlogBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'CA\\BlogBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'CA\\BlogBundle\\Entity\\User' . "\0" . 'mail', '' . "\0" . 'CA\\BlogBundle\\Entity\\User' . "\0" . 'roles'];
        }
